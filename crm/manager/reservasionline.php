                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Report Reservasi Online</h5>
                                            <span>Laporan/Reservasi Online</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <a href="generate_pdf_reservasi_online.php" class="btn btn-primary">Download Report</a>
                                                <br></br>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                if ($result_reservations->num_rows > 0) {
                                                                    while ($row = $result_reservations->fetch_assoc()) {
                                                                        echo '<tr>';
                                                                        echo '<td>' . $row['id_reservation'] . '</td>'; // ID Reservasi
                                                                        echo '<td>' . $row['name_services'] . '</td>'; // Nama Layanan
                                                                        echo '<td>' . $row['name_tourist'] . '</td>'; // Nama Wisatawan
                                                                        echo '<td>' . $row['reservation_date'] . '</td>'; // Tanggal Reservasi
