                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Report Reservasi Offline</h5>
                                            <span>Laporan/Reservasi Offline</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <a href="generate_pdf_reservasi_offline.php" class="btn btn-primary">Download Report</a>
                                                <br></br>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if ($result_reservations->num_rows > 0) {
                                                                while ($row = $result_reservations->fetch_assoc()) {
                                                                    echo '<tr>';
                                                                    echo '<td>' . $row['id_offline_reservation'] . '</td>'; // ID Reservasi
                                                                    echo '<td>' . $row['name_services'] . '</td>'; // Nama Layanan
                                                                    echo '<td>' . $row['name_off_tourist'] . '</td>'; // Nama Wisatawan
                                                                    echo '<td>' . $row['visit_start_date'] . '</td>'; // Tanggal Mulai Kunjungan
                                                                    echo '<td>' . $row['visit_end_date'] . '</td>'; // Tanggal Akhir Kunjungan
                                                                    echo '</tr>';
                                                                }
                                                            } else {
                                                                echo '<tr><td colspan="5">No reservations available.</td></tr>';
                                                            }
                                                            ?>
                                                        </tbody>
                                                    </table>
