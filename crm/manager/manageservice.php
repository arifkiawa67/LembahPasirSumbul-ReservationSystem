...
<body>
    ...
    <div class="card-header">
        <h5>Tambahkan Data Service</h5>
    </div>
    <div class="card-block">
                        <form action="insert_service.php" method="POST">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Nama Service</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name_services" class="form-control" placeholder="Masukkan nama service" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="desc_services" class="form-control" placeholder="Masukkan deskripsi service" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="price_services" class="form-control" placeholder="Masukkan harga" step="0.01" required>
                                </div>
                            </div>
                        ...
                        <div class="card-block p-b-0">
                            <div class="table-responsive">
                                <table class="table table-hover m-b-0">
                                    ...
                                    <tbody>
                                        <?php
                                        // Query untuk mengambil data dari tb_services
                                        $query_services = "SELECT id_services, name_services, desc_services, price_services FROM tb_services";
                                        ...
                                        if ($result_services->num_rows > 0) {
                                            while ($row = $result_services->fetch_assoc()) {
                                                ...
                                                echo '<td>' . $row['desc_services'] . '</td>';
                                                echo '<td>' . number_format($row['price_services'], 2) . '</td>';
                                                echo '<td>
                                                        <a href="edit_service.php?id=' . $row['id_services'] . '" class="btn btn-warning btn-sm">Edit</a>
                                                        <a href="delete_service.php?id=' . $row['id_services'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Apakah Anda yakin ingin menghapus service ini?\')">Delete</a>
                                                      </td>';
                                                echo '</tr>';
                                            }
                                        } else {
                                            echo '<tr><td colspan="5">Tidak ada data service tersedia.</td></tr>';
                                        }
                                        ?>
                                    </tbody>
                                </table>
