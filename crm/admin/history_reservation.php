...
$query_reservation = "
    ...
    WHERE ofr.id_status IN (5,6,7,8);";
...
<head>
    ...
    <link rel="stylesheet" href="../manager/css/chartist.css" type="text/css" media="all">
                                ...
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            ...
                                            <span>Reservasi/Riwayat Reservasi</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="card-block">
                                                    <div class="card">
                                                        ...
                                                        <h5>Daftar Riwayat Reservasi</h5>
