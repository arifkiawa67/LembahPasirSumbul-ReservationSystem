...
if ($action === 'complete') {
    $query = "UPDATE tb_offline_reservaion SET id_status = ?, visit_end_date = NOW() WHERE id_offline_reservation = ?";
} else {
    $query = "UPDATE tb_offline_reservaion SET id_status = ? WHERE id_offline_reservation = ?";
}
